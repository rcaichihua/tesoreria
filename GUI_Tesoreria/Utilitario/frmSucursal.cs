        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (this.dgvSucursal.RowCount > 0)
            {
                ...
                try
                {
                    ...
                    if (usuariosSuc > 0)
                    {
                        MessageBox.Show("Hay "+ usuariosSuc + " usuario(s) asignados a esta sucursal y no se puede eliminar.", VariablesMetodosEstaticos.encabezado, MessageBoxButtons.OK,
        ...
        private void btnGuardar_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (accion == "I")
                {
                    ...
                    {
                        MessageBox.Show("Nombre de sucursal ya existe, elija otro", VariablesMetodosEstaticos.encabezado, MessageBoxButtons.OK,
                                       MessageBoxIcon.Information, MessageBoxDefaultButton.Button1);
                        txtNombre.Focus();
                        return;
                    }
                ...
                else if (accion == "U")
                {
                    if (Convert.ToInt32(cboPrograma.SelectedValue) != Convert.ToInt32(dgvSucursal.Rows[indice].Cells[4].Value))
                    {
                        ...
                        {
                            MessageBox.Show("hay usuarios que han realizado movimiento de caja y es imposible realizar cambios en esta sucursal.", VariablesMetodosEstaticos.encabezado, MessageBoxButtons.OK,
