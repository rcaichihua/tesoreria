...
namespace GUI_Tesoreria
{
    public partial class frmExportarIngresos : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("No se genero el archivo EC, intente nuevamente.","",MessageBoxButtons.OK,MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MessageBox.Show("No se genero el archivo EP, intente nuevamente.", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            {
                MessageBox.Show("No se genero el archivo REC, intente nuevamente.", "", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            MessageBox.Show("Se generaron los archivos correctamente","",MessageBoxButtons.OK,MessageBoxIcon.Information);
        }
