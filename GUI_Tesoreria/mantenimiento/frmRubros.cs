...
{
    public partial class frmRubros : DevComponents.DotNetBar.Metro.MetroForm//Form
    {
        ...
        private static frmRubros frmInstance = null;
        ...
        public static frmRubros Instance()
        {
            if (((frmInstance == null) || (frmInstance.IsDisposed == true)))
            {
                frmInstance = new frmRubros();
            }
        ...
        private void dgvPrograma_Click(object sender, EventArgs e)
        {
            if (dgvRubros.RowCount > 0) { CargaDatosxId(); }
        }
        private void cargarRubros()
        {
            ...
            try
            {
                dt = cn.TraerDataset("usp_select_rubro_all_x_id", "0000").Tables[0];
                //dgvRubros.Refresh();
        ...
        public void CargaDatosxId()
        {
            try
            {
                ...
                if (dgvRubros.RowCount > 0)
                {
                    ...
                    dt = cn.TraerDataset("usp_select_rubro_all_x_id", xcod).Tables[0];
        ...
        private void txtFiltro_TextChanged(object sender, EventArgs e)
        {
            try
            {
                dgvRubros.DataSource = cn.TraerDataset("usp_select_rubro_all_x_name", txtFiltro.Text.Trim()).Tables[0];
            }
            catch (Exception)
            {
