...
{
    public partial class frmListadoRecibosTotal : DevComponents.DotNetBar.Metro.MetroForm//Form
    {
        private static frmListadoRecibosTotal frmInstance = null;

        public static frmListadoRecibosTotal Instance()
        {
            if (((frmInstance == null) || (frmInstance.IsDisposed == true)))
            {
                frmInstance = new frmListadoRecibosTotal();
            }
        ...
        private void LlenaRecibo()
        {
            ...
            dt = cn.TraerDataset("usp_ListaReciboCajaxProgramaTotal", txtNroLiquidacion.Text.Trim() == "" ? null : txtNroLiquidacion.Text.Trim(),
            ...
            if (dt.Rows.Count <= 0)
            {
                ...
                DevComponents.DotNetBar.MessageBoxEx.Show("No hay datos para mostrar con el filtro seleccionado.", VariablesMetodosEstaticos.encabezado,
        ...
        private void frmListadoRecibosTotal_Load(object sender, EventArgs e)
        {
