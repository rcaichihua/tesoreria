...
namespace DescripcionMonto
{
    public class NumLetra
    {
        ...
        private String[] CENTENAS = {"", "ciento ", "dos cientos ", "tres cientos ", "cuatro cientos ", "quinientos ", "seis cientos ",
        "siete cientos ", "ocho cientos ", "nueve cientos "};
        ...
        public String Convertir(String numero, bool mayusculas)
        {
            ...
            if (mc.Count > 0)
            {
                ...
                if (literal.Substring(0, 3) == "uno")
                {
                    literal_temp = literal.Substring(3, literal.Length - 3);
                    literal = "un" + literal_temp;
                }
